  ...
  if (!accountId) {
    return (
      <main className="p-6 text-center">
        ...
        <button onClick={() => connectWallet()} className="px-4 py-2 bg-blue-600 rounded text-white">
          Connect Wallet
        </button>
      </main>
    );
  ...
  return (
    <main className="p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/assets/create" className="px-3 py-2 bg-green-600 rounded text-white">Create Asset</Link>
      </div>
